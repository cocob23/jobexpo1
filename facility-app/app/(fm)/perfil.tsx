...
export default function PerfilFacilityManager() {
  ...
  // Actualizar user_metadata (opcional)
  ...
  // ✅ Guardar ruta en la tabla usuarios (clave para mostrar después)

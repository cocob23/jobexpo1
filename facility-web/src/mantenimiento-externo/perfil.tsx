// src/mantenimiento-externo/perfil.tsx
  ...
  return (
    <div style={styles.contenedor}>
      <div style={styles.headerContainer}>
        <button onClick={() => navigate('/mantenimiento-externo')} style={styles.botonVolver}>
          ← Volver
        </button>
      </div>
      ...
      <div style={styles.perfilContainer}>
        <img
          src={
            ...
            'https://ui-avatars.com/api/?name=EXT&background=ccc&color=000&size=128'
          }
          alt="foto perfil"
          style={styles.avatar}
        />
